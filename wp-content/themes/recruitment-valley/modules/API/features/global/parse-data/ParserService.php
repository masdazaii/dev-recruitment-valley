...
class ParserService
{
    ...
    public function testParse()
    {
        ...
        //                 if (aray_key_exists('streetAddress', $tagValueArray) && $tagValueArray['streetAddress'] !== "") {
        ...
        //                 /** ACF expired_at */
        //                 if (aray_key_exists('expirationDate', $tagValueArray) && $tagValueArray['expirationDate'] != "") {
        ...
        //                     $payload['working-hours'] = $this->_findTerms($this->_taxonomyKey['education'], preg_replace('/[\n\t]+/', '', $tagValueArray['education']));
        //                 }
        ...
        //                 print('<pre>' . print_r($i . ' : ' . $tagValueArray['streetAddress'], true) . '</pre>');
        //             } else {
