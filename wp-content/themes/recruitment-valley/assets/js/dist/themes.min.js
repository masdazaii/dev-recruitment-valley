...
/* harmony import */ var _polyfills__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./polyfills */ "./assets/js/src/themes/polyfills.js");
/* harmony import */ var _bd_stores__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @bd-stores */ "./assets/js/src/themes/stores/index.js");


(0,_bd_stores__WEBPACK_IMPORTED_MODULE_1__.subscribe)(function (store) {
...
setTimeout(function () {
  (0,_bd_stores__WEBPACK_IMPORTED_MODULE_1__.setStoreValue)("isFirebaseInitialized", true);
}, 3000);
var testActionWorkflows = function testActionWorkflows() {
  return console.error("blablabla");
};
testActionWorkflows();

/***/ }),

/***/ "./assets/js/src/themes/polyfills.js":
/*!*******************************************!*\
  !*** ./assets/js/src/themes/polyfills.js ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_200__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_200___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_200__);
/* harmony import */ var core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_201__ = __webpack_require__(/*! core-js/modules/web.dom-collections.iterator.js */ "./node_modules/core-js/modules/web.dom-collections.iterator.js");
/* harmony import */ var core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_201___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_201__);
/* harmony import */ var core_js_modules_web_immediate_js__WEBPACK_IMPORTED_MODULE_202__ = __webpack_require__(/*! core-js/modules/web.immediate.js */ "./node_modules/core-js/modules/web.immediate.js");
/* harmony import */ var core_js_modules_web_immediate_js__WEBPACK_IMPORTED_MODULE_202___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_immediate_js__WEBPACK_IMPORTED_MODULE_202__);
/* harmony import */ var core_js_modules_web_queue_microtask_js__WEBPACK_IMPORTED_MODULE_203__ = __webpack_require__(/*! core-js/modules/web.queue-microtask.js */ "./node_modules/core-js/modules/web.queue-microtask.js");
/* harmony import */ var core_js_modules_web_queue_microtask_js__WEBPACK_IMPORTED_MODULE_203___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_queue_microtask_js__WEBPACK_IMPORTED_MODULE_203__);
/* harmony import */ var core_js_modules_web_timers_js__WEBPACK_IMPORTED_MODULE_204__ = __webpack_require__(/*! core-js/modules/web.timers.js */ "./node_modules/core-js/modules/web.timers.js");
/* harmony import */ var core_js_modules_web_timers_js__WEBPACK_IMPORTED_MODULE_204___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_timers_js__WEBPACK_IMPORTED_MODULE_204__);
/* harmony import */ var core_js_modules_web_url_js__WEBPACK_IMPORTED_MODULE_205__ = __webpack_require__(/*! core-js/modules/web.url.js */ "./node_modules/core-js/modules/web.url.js");
/* harmony import */ var core_js_modules_web_url_js__WEBPACK_IMPORTED_MODULE_205___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_url_js__WEBPACK_IMPORTED_MODULE_205__);
/* harmony import */ var core_js_modules_web_url_to_json_js__WEBPACK_IMPORTED_MODULE_206__ = __webpack_require__(/*! core-js/modules/web.url.to-json.js */ "./node_modules/core-js/modules/web.url.to-json.js");
/* harmony import */ var core_js_modules_web_url_to_json_js__WEBPACK_IMPORTED_MODULE_206___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_url_to_json_js__WEBPACK_IMPORTED_MODULE_206__);
/* harmony import */ var core_js_modules_web_url_search_params_js__WEBPACK_IMPORTED_MODULE_207__ = __webpack_require__(/*! core-js/modules/web.url-search-params.js */ "./node_modules/core-js/modules/web.url-search-params.js");
/* harmony import */ var core_js_modules_web_url_search_params_js__WEBPACK_IMPORTED_MODULE_207___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_url_search_params_js__WEBPACK_IMPORTED_MODULE_207__);
...
/***/ "./assets/js/src/themes/stores/index.js":
/*!**********************************************!*\
  !*** ./assets/js/src/themes/stores/index.js ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   getStoreValue: function() { return /* binding */ getStoreValue; },
/* harmony export */   setStoreValue: function() { return /* binding */ setStoreValue; },
 ...
 * @returns {boolean}
 */
var checkKeyExistence = function checkKeyExistence(name, errorMethod) {
  var isKeyExist = Object.keys(store).includes(name);
  if (!isKeyExist) {
    console.error("Trying to ".concat(errorMethod, " non-existing key of '").concat(name, "'"));
    return false;
  }
  return true;
};
 ...
 */
var setStoreValue = function setStoreValue(name, newValue) {
  var isExist = checkKeyExistence(name, "set");
  if (!isExist) return;
  store[name] = newValue;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).trigger("bd-store:".concat(name), store);
  return store;
};
 ...
 */
var getStoreValue = function getStoreValue(name) {
  var isExist = checkKeyExistence(name, "get");
  if (!isExist) return;
  return store[name];
};
 ...
 */
var subscribe = function subscribe(callback, property) {
  var isArray = Array.isArray(property);
  var properties = isArray ? property : [property];
  var events = properties.map(function (property) {
    return "bd-store:".concat(property);
  }).join(" ");
  var localCallback = function localCallback(e, store) {
    return callback(store);
  };
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on(events, localCallback);
  return function () {
    return jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).off(events, localCallback);
  };
};
