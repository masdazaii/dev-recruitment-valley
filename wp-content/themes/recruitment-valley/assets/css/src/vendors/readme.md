...
> ### Note:
>
> But before this, consider to just using package manager such as NPM, and import the vendors stylesheet that you want to use into the main file.
>
> Because it would be easier to manage :))
